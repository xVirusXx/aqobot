...
function class.initSpellLines(_aqo)
    class.addSpell('heal', {'Ancient: Hallowed Light', 'Pious Light', 'Holy Light', 'Divine Light', 'Healing Light', 'Superior Healing', 'Greater Healing' , 'Healing' , 'Light Healing', 'Minor Healing'}, {tank=true, panic=true, regular=true})
    ...
    class.addSpell('groupheal', {'Word of Vivification', 'Word of Replenishment', 'Word of Redemption' , 'Word of Healing' , 'Word of Health'}, {threshold=3, group=true, pct=70})
    class.addSpell('hottank', {'Pious Elixir', 'Holy Elixir', 'Celestial Healing', 'Celestial Remedy'}, {opt='USEHOTTANK', hot=true})
    class.addSpell('hotdps', {'Pious Elixir', 'Holy Elixir', 'Celestial Healing', 'Celestial Remedy'}, {opt='USEHOTDPS', hot=true})
